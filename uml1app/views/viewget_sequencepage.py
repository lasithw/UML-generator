            ...
            for component in usecase_list:
                ...
                if (component[10] == 0 or component[10] == 'None'):
                    ...
                    if (component[3] == 1 or component[11] == 1):
                        ...
                        os.write(fd, (str(sender).lower() + "->" + (str(reciever).lower()).replace(" ", "") + ":" +
                                      component[2] + "\n").encode('ascii'))
    ...
    if request.method == 'POST':
        ...
        for values in list1:
            if (values['conditionBit'] != '1' and values['loop'] != '1'):
                os.write(fd, ("" + values['sender'] + "--->(" + values['Message'] + "--->:" + values[
                ...
                if (values['else_loop'] != '1'):
                    ...
                    os.write(fd, b"\n")
                    os.write(fd, b"else\n")
                    os.write(fd, ("[alt] :[loop]: " + values['sender_else'] + "--->(" + values['elsemsg'] + "--->:" +
                                  values[
                                      'MessageType'] + ")---> " + values['reciver_else']).encode('ascii'))
        # Close opened file
        os.close(fd)
